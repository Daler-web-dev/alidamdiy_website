    ...
    <>
          ...
          <div className="flex items-center gap-14 px-72 max-xl:px-40 max-lg:px-10 max-md:px-0">
            ...
            <div className="">
              <p className="leading-[190%] tracking-[-0.011em] text-[#474747]">
                Выбирайте всё что вам по вкусу, наш широкий ассортимент
                автомобилей всегда придётся вам по нраву!
              </p>
            </div>
          </div>
          <div className="">
      ...
      <section className="bg-[#1E1E1E] mb-[63px]">
        <div className="relative -top-20 w-full overflow-hidden py-6">
          <div className="relative right-4 w-[110%] py-10 rotate-[-1.28deg] bg-[#E31E24]">
            <h2 className="text-center text-[64px] font-bold leading-[105%] tracking-[-0.011em] text-white">
              Мы в цифрах
            </h2>
          </div>
        </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="p-3 text-white">
                <p className="text-center leading-[115%] tracking-[-0.011em]">
                  Доступное количество автомобилей
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-center p-3 text-white">
                <p className="leading-[115%] tracking-[-0.011em]">
                  Арендовано автомобилей за 1 год
                </p>
              </div>
            </div>
      ...
      <section>
        <div className="container mx-auto px-24 mb-[30px]">
          <div className="flex">
            <div className="w-1/2">
              <h3 className="text-[64px] leading-[105%] tracking-[-0.011em] text-[#E31E24]">
                Частые <br /> вопросы
              </h3>
            </div>
            <div className="w-1/2 flex flex-col gap-8">
              <div className="relative">
                ...
                <h3 className="mb-3 text-[28px] font-bold leading-[115%] tracking-[-0.011em]">
              ...
              <div className="relative">
                <div className="absolute top-5 -left-10 w-6 h-6 rounded-full bg-[#E31E24]"></div>
                <h3 className="mb-3 text-[28px] font-bold leading-[115%] tracking-[-0.011em]">
                  Как мы предоставляем аренду машины?
                </h3>
                <p className="leading-[190%] tracking-[-0.011em] text-[#474747]">
                  Всё очень просто! Заполните короткую форму и в течении 12
                  часов мы свами свяжемся для предоставления подробной
                  информациии
                </p>
              </div>
            </div>
          ...
          <div className="mt-[68px]">
            <p className="text-3xl leading-[190%] tracking-[-0.011em]">
              Готовы отправиться в захватывающее приключение? Наша компания
              предлагает широкий выбор автомобилей для аренды, специально
              разработанных для путешествий!
            </p>
          ...
          <div className="w-2/5">
            ...
            <div className="">
              <p className="text-xl leading-[190%] tracking-[-0.011em] text-[#FAFAFA]">
                Оставьте заявку, и мы обязательно свяжемся чтобы помочь вам
                выбрать, то что вас интересует!
              </p>
            </div>
          </div>
          <div className="w-3/5 py-[66px] px-14 rounded-[15px] shadow-[0px_4px_16px_#00000040] bg-[#FAFAFA]">
            <h2 className="text-4xl font-bold leading-[115%] tracking-[-0.011em] mb-8">
              Оставить заявку
            </h2>
