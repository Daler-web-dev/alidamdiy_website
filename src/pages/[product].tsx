					...
					>
						...
						>
							<div>
								...
								<div className="flex max-[500px]:flex-col items-center gap-6 max-md:gap-4 max-sm:gap-3">
									<input
										type="text"
								...
								<div className="mt-8 flex items-center gap-9 max-xl:gap-5">
									<div className="h-2/5" onClick={() => setSuccess(true)}>
										<button type="submit" className="font-medium leading-[150%] tracking-[-0.011em] px-6 max-lg:px-4 py-2 rounded-[5px] ease-in duration-150 hover:shadow-[0_0_10px_#E31E24] bg-[#E31E24] text-white">{translation?.modal.btn}</button>
									</div>
									<div className="w-3/4">
