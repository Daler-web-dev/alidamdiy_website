...
export default function product(props: IAppProps) {
	...
	return (
		<div className="container mx-auto px-24 max-xl:px-14 max-lg:px-5 mt-4">
			<h1 className='text-3xl max-lg:text-2xl font-["MyFont"] mb-2'>Chevrolet Orlando</h1>
			...
			<div className="w-full flex max-lg:flex-col gap-8 justify-between">
				...
				<div className="w-1/2 max-lg:w-full">
					...
					<form action="">
						...
						<hr className="border-0 h-px bg-[#858585] mb-4" />
						<div className="w-full flex items-center justify-between mb-2">
							<h1 className='font-["MyFont"] text-3xl max-lg:text-2xl max-md:text-xl'>Стоимость:</h1>
							<h1 className='font-["MyFont"] text-3xl max-lg:text-2xl max-md:text-xl text-[#E31E24]'>250$</h1>
						</div>
			...
			<div className="w-full mt-8 h-fit bg-[#fffffe] max-xl:overflow-y-scroll">
				<div className="max-xl:w-[1240px]">
					...
					{
						desc.map((i, idx) => <div key={idx} className="flex items-center">
