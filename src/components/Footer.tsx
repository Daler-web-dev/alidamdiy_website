...
const Footer: React.FC<FooterProps> = () => {
	...
	return (
		<footer className="w-full mt-[90px] max-lg:mt-20 max-md:mt-10 max-sm:mt-7 rounded-t-[16px] bg-[#BBBBBB]">
			...
			<div className="py-10 border border-white">
				<p className="text-center">Made by <span className="hover:underline underline-offset-4"><Link href={'https://www.instagram.com/wisetech.solutions/'}>©WiseTech Solutions</Link></span>. All Rights Reserved.</p>
			</div>
		</footer>
	);
};
