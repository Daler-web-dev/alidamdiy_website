...
const Header: React.FC<HeaderProps> = ({ }) => {
	...
	return (
		<>
			...
			<div className={
				searchInp ? "w-full h-screen fixed top-0 left-0 bg-[rgba(236,236,236,.8)] z-50 duration-200 ease-in" : "w-full h-screen absolute -top-full left-0 bg-[rgba(236,236,236,.8)] z-50"
			}
				onClick={reset}
			>
