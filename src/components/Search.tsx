		...
		<div className="container mx-auto px-24 max-xl:px-14 max-lg:px-5 mt-4">
			<form action="" onSubmit={handleSubmit(submit)}>
				<div className="w-full flex max-lg:flex-col max-xl:gap-5 items-center max-lg:items-start">
					<div className="max-lg:w-full flex items-center w-[60%] max-lg:items-start max-[530px]:flex-col max-[530px]:gap-3">
						<div className="w-[300px] max-sm:w-full h-[70px] border-[0.25px] border-[#000] rounded-tl-2xl rounded-bl-2xl flex flex-col px-3 py-2 gap-1 max-[530px]:rounded-2xl max-[380px]:w-full">
						...
						<div className="w-[300px] max-sm:w-full h-[70px] border-[0.25px] border-[#000] rounded-br-2xl rounded-tr-2xl flex flex-col px-3 py-2 gap-1 max-[530px]:rounded-2xl max-[380px]:w-full">
							<label className="max-sm:text-xs" htmlFor="car-name">
								ТИП АВТО
							</label>
							<select
					...
					<div className="max-lg:w-[82.5%] max-sm:w-full w-[40%] flex items-center gap-5 max-[380px]:flex-col">
						<Controller
							control={control}
							name="range"
						...
						<div>
							<Button
								variant="contained"
								className="w-64 max-sm:w-[184px] h-16 max-sm:h-11 rounded-2xl max-[380px]:w-[250px] max-[380px]:h-16
